...
public class AutoDeliverBoxMtoR extends CommandGroup {
    ...
    public AutoDeliverBoxMtoR() {
        ...
        // arm.
    	addSequential(new MoveStraight(Direction.FORWARD, .75, 40));
    	addSequential(new TurnCommand(Direction.RIGHT, .5, 90));
    	addSequential(new MoveStraight(Direction.FORWARD, .75, 115));
    	addSequential(new TurnCommand(Direction.LEFT, .5, 90));
    	addSequential(new MoveStraight(Direction.FORWARD, .75, 100));
    	addSequential(new TurnCommand(Direction.LEFT, .5, 5));
